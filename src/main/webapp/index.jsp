...
<header class="header-background">
    ...
    <div class="hero-content">
        ...
        <p class="hero-subtitle">Sostieni una specie e ricevi in regalo un kit di adozione.
        Grazie al tuo aiuto possiamo fare la differenza nella conservazione di specie a rischio</p>
