...
INSERT INTO specie_animale (nome, descrizione, prezzo, url_image) VALUES
                                                                      ('Tigre', 'La tigre è il più grande felino vivente, nota per le sue strisce nere distintive e la sua forza.', 15000.00, 'images/tigre.jpg'),
                                                                      ('Rinoceronte', 'Il rinoceronte è un grande mammifero perissodattilo, noto per il suo o i suoi corni sul naso.', 20000.00, 'images/rinoceronte.jpg'),
                                                                      ('Leone', 'Il leone, spesso chiamato "re della giungla", è un grande felino caratterizzato dalla criniera nei maschi.', 12000.00, 'images/leone.jpg'),
                                                                      ('Tartaruga', 'La tartaruga è un rettile con un guscio osseo o cartilagineo, noto per la sua longevità.', 500.00, 'images/tartaruga.jpg'),
                                                                      ('Elefante', 'L''elefante è il più grande animale terrestre, caratterizzato dalla sua proboscide e dalle grandi orecchie.', 30000.00, 'images/elefante.jpg');